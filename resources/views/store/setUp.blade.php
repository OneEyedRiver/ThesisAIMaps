...
<div>
     <label class="m-1"for="longitude">longitude:</label>
  <input 
    ...
    value="{{old('longitude')}}"
        ...
        class="w-[330px] sm:w-[300px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5  mb-3" placeholder="longitude"
  ...
  <div>
     <label class="m-1"for="longitude">Latitude:</label>
  <input 
    ...
    value="{{old('latitude')}}"
        ...
        class="w-[330px] sm:w-[300px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5  mb-3" placeholder="latitude"
